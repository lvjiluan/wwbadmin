<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/Users/lvjiluan/project/wwbadmin/app/admin/view/content/slideAdd.html";i:1519818196;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="car_title"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>轮播图描述" class="layui-input">
            </div>
        </div>
            ...
            <div class="layui-input-block">
                <div class="site-demo-upload">
                    ...
                    <div class="site-demo-upbar">
                        ...
                        <input type="file" lay-verify="required"  style="display: none" onchange="imgChange(event)" name="thumb" lay-type="images" class="layui-upload-file" id="thumb">
                     </div>
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="car_url"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>跳转链接" class="layui-input">
            </div>
        </div>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(auth)', function (data) {
                ...
                $.post("<?php echo url('slideAdd'); ?>",data.field,function(res){
                    if(res.code > 0){
