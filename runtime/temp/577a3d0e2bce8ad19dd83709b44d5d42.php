<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"D:\www\admin/app/admin\view\organization\commentAdd.html";i:1519907131;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>添加机构评论信息</title>
    ...
    <form class="layui-form layui-form-pane"  enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="oco_grade"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>评价星级" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="oco_click"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>浏览量" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="oco_com"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>留言数" class="layui-input">
            </div>
        </div>
