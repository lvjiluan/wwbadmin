<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"D:\www\admin/app/admin\view\content\circlearticleAdd.html";i:1519995419;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="margin: 15px;"  ng-app="hd" ng-controller="ctrl">
    ...
    <form class="layui-form layui-form-pane" enctype="multipart/form-data">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea id="tma_content" name="tma_content" ng-model="field.tma_content"  placeholder="请输入文章内容" class="layui-textarea"></textarea>
            </div>
        </div>
