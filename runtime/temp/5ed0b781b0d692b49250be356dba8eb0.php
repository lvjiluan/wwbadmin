<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/Users/lvjiluan/project/wwbadmin/app/admin/view/organization/lessonEdit.html";i:1519745696;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" ng-model="field.tol_lesson_name" name="tol_lesson_name"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>课程服务名称" class="layui-input">
            </div>
        </div>
...
<script>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        ...
        $scope.field = '<?php echo $lessoninfo; ?>'!='null'?<?php echo $lessoninfo; ?>:{tol_id:''};
        ...
        layui.use(['form', 'layer','layedit'], function () {
            ...
            form.on('submit(auth)', function (data) {
                ...
                $.post("<?php echo url('lessonEdit'); ?>",data.field,function(res){
                    if(res.code > 0){
