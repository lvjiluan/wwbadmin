<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"D:\www\admin/app/admin\view\content\circlearticle.html";i:1519995581;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    ...
    function del(id) {
        layer.confirm('删除文章后，对该文章的评论也将全部删除！<?php echo lang("Are you sure you want to delete it"); ?>', {icon: 3}, function (index) {
