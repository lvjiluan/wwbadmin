<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"D:\www\admin/app/admin\view\auth\adminForm.html";i:1519907173;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="margin: 15px;" ng-app="hd" ng-controller="ctrl">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="adm_username" ng-model="field.adm_username" lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>登录用户名" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="password" name="adm_pwd" placeholder="<?php echo lang('pleaseEnter'); ?>登录密码" lay-verify="required" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                密码必须大于6位，小于15位.
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="adm_email" ng-model="field.adm_email" lay-verify="email" placeholder="<?php echo lang('pleaseEnter'); ?>用户邮箱" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                用于密码找回，请认真填写.
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="adm_phone" ng-model="field.adm_phone" lay-verify="phone" value="" placeholder="<?php echo lang('pleaseEnter'); ?>手机号" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item" ng-if="field.adm_id != 1">
            ...
            <div class="layui-input-block">
                <input type="radio" name="adm_isopen"  ng-model="field.adm_isopen" ng-checked="field.adm_isopen==1" ng-value="1" title="<?php echo lang('open'); ?>">
                <input type="radio" name="adm_isopen" ng-model="field.adm_isopen" ng-checked="field.adm_isopen==0" ng-value="0" title="<?php echo lang('close'); ?>">
            </div>
        </div>
...
<script>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        $scope.field = '<?php echo $info; ?>'!='null'?<?php echo $info; ?>:{adm_id:'',adm_orgid:'',adm_username:'',adm_email:'',adm_isopen:1},
