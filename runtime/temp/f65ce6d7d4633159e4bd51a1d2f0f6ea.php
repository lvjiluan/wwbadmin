<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/Users/lvjiluan/project/wwbadmin/app/admin/view/organization/basicEdit.html";i:1519745685;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <form class="layui-form layui-form-pane"  enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="org_type" ng-checked="field.org_type=='1'" ng-value="1" title="民办">
                <input type="radio" name="org_type" ng-checked="field.org_type=='2'" ng-value="2" title="公办">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="ode_lon" ng-model="field.ode_lon"  lay-verify="" placeholder="<?php echo lang('pleaseEnter'); ?>纬度" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">维度</label>
            <div class="layui-input-6">
                <input type="text" name="ode_lat" ng-model="field.ode_lat"  lay-verify="" placeholder="<?php echo lang('pleaseEnter'); ?>经度" class="layui-input">
            </div>
        </div>
