<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/Users/lvjiluan/project/wwbadmin/app/admin/view/organization/lesson.html";i:1519745694;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-field-box table-responsive">
            ...
            <table class=" layui-table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" tol_id="<?php echo $v['tol_id']; ?>" id="layerDemo<?php echo $v['tol_id']; ?>" data-method="setTop" class="layui-btn layui-btn-mini">查看</a>
