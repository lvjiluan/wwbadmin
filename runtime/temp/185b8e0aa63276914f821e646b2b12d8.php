<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"D:\www\admin/app/admin\view\organization\lessonAdd.html";i:1519907127;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="tol_lesson_name"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>课程服务名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="tol_lesson_type" ng-value="1" title="课程">
                <input type="radio" name="tol_lesson_type" ng-value="2" title="服务">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <a href="<?php echo url('lesson'); ?>" class="layui-btn layui-btn-primary">返回</a>
            </div>
        </div>
    </form>
</div>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        ...
        layui.use(['form', 'layer','layedit'], function () {
            ...
            form.on('submit(auth)', function (data) {
                ...
                $.post("<?php echo url('lessonAdd'); ?>",data.field,function(res){
                    if(res.code > 0){
