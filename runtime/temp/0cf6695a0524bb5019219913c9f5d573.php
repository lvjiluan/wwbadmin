<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\www\admin/app/admin\view\organization\picturetypeAdd.html";i:1519907119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-6">
                <input type="text" name="opi_title"  lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>图册名称" class="layui-input">
            </div>
        </div>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(auth)', function (data) {
                // 提交到方法 默认为本身
                $.post("<?php echo url('picturetypeAdd'); ?>",data.field,function(res){
                    if(res.code > 0){
